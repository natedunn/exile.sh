...
const procedureRegistry = {
  "reserveImport": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "internal", typeof import("../buildImportBudget").reserveImport>("buildImportBudget:reserveImport"), () => (require("../buildImportBudget") as Record<string, unknown>)["reserveImport"])],
} as const;
...
export function createBuildImportBudgetCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createBuildImportBudgetHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
