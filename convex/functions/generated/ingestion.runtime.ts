...
const procedureRegistry = {
  "ingest": ["action", typedProcedureResolver(createGeneratedFunctionReference<"action", "internal", typeof generatedInternal["ingestion"]["ingest"]>("ingestion:ingest"), () => (require("../ingestion") as Record<string, unknown>)["ingest"])],
} as const;
...
export function createIngestionCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createIngestionHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
