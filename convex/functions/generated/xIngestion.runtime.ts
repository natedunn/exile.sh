...
const procedureRegistry = {
  "poll": ["action", typedProcedureResolver(createGeneratedFunctionReference<"action", "internal", typeof import("../xIngestion").poll>("xIngestion:poll"), () => (require("../xIngestion") as Record<string, unknown>)["poll"])],
} as const;
...
export function createXIngestionCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createXIngestionHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
