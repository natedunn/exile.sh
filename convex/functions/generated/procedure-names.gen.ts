...
export const procedureNames = {
  ...
  "patchIngestion.ts": [{ column: 54, line: 23, name: "patchIngestion:poll" }, { column: 96, line: 8, name: "patchIngestion:post" }],
  "patchStore.ts": [{ column: 88, line: 23, name: "patchStore:acquire" }, { column: 153, line: 16, name: "patchStore:discover" }, { column: 183, line: 29, name: "patchStore:finish" }, { column: 54, line: 7, name: "patchStore:latest" }, { column: 62, line: 12, name: "patchStore:post" }],
