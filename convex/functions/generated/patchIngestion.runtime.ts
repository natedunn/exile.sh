...
const procedureRegistry = {
  "poll": ["action", typedProcedureResolver(createGeneratedFunctionReference<"action", "internal", typeof generatedInternal["patchIngestion"]["poll"]>("patchIngestion:poll"), () => (require("../patchIngestion") as Record<string, unknown>)["poll"])],
  "post": ["action", typedProcedureResolver(createGeneratedFunctionReference<"action", "internal", typeof generatedInternal["patchIngestion"]["post"]>("patchIngestion:post"), () => (require("../patchIngestion") as Record<string, unknown>)["post"])],
} as const;
...
export function createPatchIngestionCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createPatchIngestionHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
