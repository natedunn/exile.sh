...
const procedureRegistry = {
  "local": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "internal", typeof import("../seed").local>("seed:local"), () => (require("../seed") as Record<string, unknown>)["local"])],
} as const;
